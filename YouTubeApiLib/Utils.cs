...
namespace YouTubeApiLib
{
    public static class Utils
    {
        ...
        public static YouTubeVideo MakeYouTubeVideo(RawVideoInfo rawVideoInfo, SimplifiedVideoInfo simplifiedVideoInfo)
        {
            ...
            {
                mediaTracks = ParseStreamingData(jStreamingData);
            }
        ...
        internal static LinkedList<YouTubeMediaTrack> ParseStreamingData(JObject jStreamingData)
        {
                ...
                foreach (JObject jFormat in jaAdaptiveFormats)
                {
                    ...
                    if (mimeType.Contains("video"))
                    {
                        ...
                        if (jt != null)
                        {
                            ...
                            Dictionary<string, string> dict = SplitStringToKeyValues(t, '&', '=');
